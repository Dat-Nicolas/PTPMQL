...
function Navbar() {
 ...
 const handleLogout = async () => {
  ...
  const navItems = [
    ...
    { to: "/userrole", label: "điều khiển Vai trò người dùng", icon: <FaStore /> },
    { to: "/rolepermission", label: "cho phép quyền", icon: <FaStore /> },
    { to: "/God", label: "danh sách quỷ", icon: <FaStore /> },
  ];
